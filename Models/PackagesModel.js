...
const embeddedReviewSchema = new mongoose.Schema(
  {
    ...
    verified: { type: Boolean, default: false }, // true if reviewer has a confirmed booking for this package
  },
  { timestamps: true }
);
...
const packageSchema = new mongoose.Schema(
  {
    ...
    // Part C: urgency indicators — real inventory, decremented on confirmed bookings
    // (Controllers/paymentController.js) rather than the previous client-side
    // random countdown.
    seatsLeft: { type: Number, default: 30, min: 0 },
